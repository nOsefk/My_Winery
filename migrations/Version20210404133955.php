 ...
 */
final class Version20210404133955 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart_product ADD id INT AUTO_INCREMENT NOT NULL, ADD quantity INT DEFAULT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
